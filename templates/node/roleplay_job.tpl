...
<div class="row">
  ...
  <div class="col-sm-8">
    <img src="/images/roleplay/job/{{Params.sub}}.jpg" width="800" height="200" class="img-polaroid">
  </div>
  <div class="col-sm-2">
  </div>
</div>
...
<div class="row">
  <div class="col-sm-5 col-sm-offset-1">
    <ul class="nav nav-tabs" role="tablist" id="myTabs">
  		<li><a href="#/{{Params.arg}}/{{Params.sub}}?TABS=player">Membres</a></li>
  		<li><a href="#/{{Params.arg}}/{{Params.sub}}?TABS=best">Le top</a></li>
      <li><a href="#/{{Params.arg}}/{{Params.sub}}?TABS=tree">Hiérarchies</a></li>
  	</ul>
    <div class="tab-content col-md-12">
      <div role="tabpanel" class="tab-pane active row" id="player">
        ...
        <table width="100%" class="table-hover table-condensed">
          ...
          <tr ng-repeat="player in players" data-toggle="tooltip" title="{{Math.round(player.TimePlayedJob/(60*60)*10)/10}} heures dans ce job">
