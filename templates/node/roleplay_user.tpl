...
<div class="row" style="position:relative;">
  ...
  <div class="col-sm-4">
    ...
    <a class="btn btn-warning" ng-show="$parent.isAdmin" href="#/tribunal/case/{{Params.sub}}">Page du Tribunal</a>
     <a class="btn btn-info" ng-show="$parent.isAdmin" href="https://www.ts-x.eu/forum/memberlist.php?mode=viewprofile&u={{data.user_id}}">Profil Forum</a> //Reservé au admin ?
    <br /><br /><br /><br /><br />
