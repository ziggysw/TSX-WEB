		...
		<article class="col-sm-offset-1 col-sm-2">
			<div class="row">
				...
				<div class="video">
					...
					<figure><a class="various" target="_blank" href="https://www.youtube.com/watch?v=RtNNPcaTzO0" style="opacity: 1;"></a><img alt="tsx_tv" class="img_phone" src="/images/tv_tsx_brkg.png"></figure>
			    </div>
			</div>
		</article>
	</div>
