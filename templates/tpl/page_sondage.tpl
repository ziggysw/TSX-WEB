...
<form role="form" class="form-inline col-sm-offset-1 col-sm-11" action="index.php?page=sondage&action=post" method="post" id="sondage_form" ng-controller="sondage" >
	...
	<div class="progress"><div class="progress-bar" role="progressbar" aria-valuenow="{{step/80*100}}" aria-valuemin="0" aria-valuemax="100" style="width: {{step/80*100}}%;">{{step/80*100 | number: 0}}%</div></div>
	...
	<div class="rows" ng-show="step>=1 && step < 10">
		...
		<div class="form-group col-sm-12" ng-show="step==2">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q2_1" value="1" ng-click="step=3" /> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q2_1" value="0" ng-click="step=4" /> Non</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==3">
			<div class="col-sm-12">Quelles étapes trouvez-vous difficiles ?</div>
			<select name="q2_2" class="form-control col-sm-offset-3 col-sm-6">
		...
		<div class="form-group col-sm-12" ng-show="step==4">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q2_3" value="1" ng-click="step=5" /> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q2_3" value="0" ng-click="step=10" /> Non</label>
		</div>
	...
	<div class="rows" ng-show="step>=10 && step < 20">
		...
		<div class="form-group col-sm-12" ng-show="step==10">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q1" value="1" ng-click="step=11"/> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q1" value="0" ng-click="step=20" /> Non</label>
		</div>
		...
		<div class="form-group col-sm-12" ng-show="step==13">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q1_3" value="1" ng-click="step=14" /> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q1_3" value="0" ng-click="step=20"/> Non</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==14">
			<div class="col-sm-12">Sur une note de 1 à 5, notez la quête braquage</div>
			<label class="col-sm-2 col-sm-offset-1"><input type="radio" name="q1_3_1" value="1" ng-click="step=15" /> 1</label>
			<label class="col-sm-2"><input type="radio" name="q1_3_1" value="2" ng-click="step=15"/> 2</label>
			<label class="col-sm-2"><input type="radio" name="q1_3_1" value="3" ng-click="step=15"/> 3</label>
			<label class="col-sm-2"><input type="radio" name="q1_3_1" value="4" ng-click="step=16"/> 4</label>
			<label class="col-sm-2"><input type="radio" name="q1_3_1" value="5" ng-click="step=16"/> 5</label>
		</div>
	...
	<div class="rows" ng-show="step>=20 && step < 30">
		...
		<div class="form-group col-sm-12" ng-show="step==22">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q3" value="1" ng-click="step=23"/> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q3" value="0" ng-click="step=23"/> Non</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==23">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q3" value="1" ng-click="step=24"/> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q3" value="0"  ng-click="step=24"/> Non</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==24">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q3" value="1" ng-click="step=30"/> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q3" value="0"  ng-click="step=30"/> Non</label>
		</div>
	</div>
	...
	<div class="rows" ng-show="step>=40 && step < 42">
		...
		<div class="form-group col-sm-12" ng-show="step==41">
			...
			<label class="col-sm-offset-3 col-sm-8"><input type="checkbox" name="q1_2" value="0">L'argent, on y gagne beaucoup</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="checkbox" name="q1_2" value="1">Les personnes présentes dans le métier</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="checkbox" name="q1_2" value="2">Je trouve que le chef du métier fait bien son travail</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="checkbox" name="q1_2" value="3">Le prestige de faire partie de ce métier</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="checkbox" name="q1_2" value="3">Il y a toujours quelque chose à faire dans ce job</label>
	...
	<div class="rows" ng-show="step>=42 && step < 50">
		...
		<div class="form-group col-sm-12" ng-show="step==45">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q1" value="1" ng-click="step=46"/> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q1" value="0" ng-click="step=50"/> Non</label>
		</div>
	...
	<div class="rows" ng-show="step>=50 && step < 60">
		...
		<div class="form-group col-sm-12" ng-show="step==50">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q1" value="1" ng-click="step=51"/> Oui</label>
		...
		<div class="form-group col-sm-12" ng-show="step==52">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q1" value="1" ng-click="step=53"/> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q1" value="0" ng-click="step=53" /> Non</label>
		</div>
		<div class="form-group col-sm-12"  ng-show="step==53">
			<div class="col-sm-12">Connaissez-vous le bot anti-freekill ?</div>
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q1" value="1" ng-click="step=54" /> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q1" value="0" ng-click="step=54" /> Non</label>
		</div>
		<div class="form-group col-sm-12"  ng-show="step==54">
			<div class="col-sm-12">Connaissez-vous la maladie du freekill ?</div>
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q1" value="1" ng-click="step=55" /> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q1" value="0" ng-click="step=55" /> Non</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==55">
			...
			<label class="col-sm-offset-3 col-sm-8"><input type="radio" name="q1_2" value="0" ng-click="step=60">Augmenter le temps de prison pour meurtre par la police</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="radio" name="q1_2" value="1" ng-click="step=60">Augmenter le temps de prison pour meurtre par les juges</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="radio" name="q1_2" value="2" ng-click="step=60">Augmenter le temps de prison pour meurtre par le /report</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="radio" name="q1_2" value="3" ng-click="step=60">Augmenter la pénalité liée à la maladie du freekill</label>
		...
		<div class="form-group col-sm-12" ng-show="step==57">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q1" value="1" ng-click="step=60"/> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q1" value="0" ng-click="step=60" /> Non</label>
		</div>
	</div>
	...
	<div class="rows" ng-show="step>=60 && step < 70">
		...
		<div class="form-group col-sm-12" ng-show="step==60">
			...
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q1" value="1" ng-click="step=61"/> Oui</label>
		...
		<div class="form-group col-sm-12" ng-show="step==66">
			...
			<label class="col-sm-offset-3 col-sm-8"><input type="radio" name="q1_2" value="0" ng-click="step=67">Non</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="radio" name="q1_2" value="1" ng-click="step=67">Oui, il faut réduire le nombre de captures (1x/semaine)</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="radio" name="q1_2" value="2" ng-click="step=67">Oui, il faut augmenter le nombre de captures (3x/semaine)</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==67">
			<div class="col-sm-12">Pratiquez-vous fréquemment la capture du bunker ?</div>
			<label class="col-sm-offset-3 col-sm-3"><input type="radio" name="q1" value="1" ng-click="step=70"/> Oui</label>
			<label class="col-sm-3"><input type="radio" name="q1" value="0"  ng-click="step=68"/> Non</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==68">
			<div class="col-sm-12">Pourquoi ?</div>
			<label class="col-sm-offset-3 col-sm-8"><input type="checkbox" name="q1_2" value="0">Le stuff coûte trop cher</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="checkbox" name="q1_2" value="1">Je n'ai pas de groupe</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="checkbox" name="q1_2" value="2">Mon groupe n'est pas assez organisé</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="checkbox" name="q1_2" value="2">Je n'y comprends rien</label>
			<label class="col-sm-offset-3 col-sm-8"><input type="checkbox" name="q1_2" value="2">Je m'oppose au système de capture actuel</label>
	...
	<div class="rows" ng-show="step>=70 && step < 80">
		...
		<div class="form-group col-sm-12" ng-show="step==70">
			...
			<label class="col-sm-offset-1 col-sm-2"><input type="radio" name="q1_2" value="0" ng-click="step=71">Pas du tout d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="1" ng-click="step=71">Plutôt pas d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=71">Neurtre</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=71">Plutôt d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=71">Totalement d'accord</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==71">
			<div class="col-sm-12">Pensez-vous que les admins sont “de votre côté” ?</div>
			<label class="col-sm-offset-1 col-sm-2"><input type="radio" name="q1_2" value="0" ng-click="step=72">Pas du tout d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="1" ng-click="step=72">Plutôt pas d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=72">Neurtre</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=72">Plutôt d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=72">Totalement d'accord</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==72">
			...
			<label class="col-sm-offset-1 col-sm-2"><input type="radio" name="q1_2" value="0" ng-click="step=73">Pas du tout d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="1" ng-click="step=73">Plutôt pas d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=73">Neurtre</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=73">Plutôt d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=73">Totalement d'accord</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==73">
			...
			<label class="col-sm-offset-1 col-sm-2"><input type="radio" name="q1_2" value="0" ng-click="step=74">Pas du tout d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="1" ng-click="step=74">Plutôt pas d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=74">Neurtre</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=74">Plutôt d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=74">Totalement d'accord</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==74">
			...
			<label class="col-sm-offset-1 col-sm-2"><input type="radio" name="q1_2" value="0" ng-click="step=75">Pas du tout d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="1" ng-click="step=75">Plutôt pas d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=75">Neurtre</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=75">Plutôt d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=75">Totalement d'accord</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==75">
			...
			<label class="col-sm-offset-1 col-sm-2"><input type="radio" name="q1_2" value="0" ng-click="step=76">Pas du tout d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="1" ng-click="step=76">Plutôt pas d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=76">Neurtre</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=76">Plutôt d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=76">Totalement d'accord</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==76">
			...
			<label class="col-sm-offset-1 col-sm-2"><input type="radio" name="q1_2" value="0" ng-click="step=77">Pas du tout d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="1" ng-click="step=77">Plutôt pas d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=77">Neurtre</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=77">Plutôt d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=77">Totalement d'accord</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==77">
			...
			<label class="col-sm-offset-1 col-sm-2"><input type="radio" name="q1_2" value="0" ng-click="step=78">Pas du tout d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="1" ng-click="step=78">Plutôt pas d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=78">Neurtre</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=78">Plutôt d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=78">Totalement d'accord</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==78">
			...
			<label class="col-sm-offset-1 col-sm-2"><input type="radio" name="q1_2" value="0" ng-click="step=79">Pas du tout d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="1" ng-click="step=79">Plutôt pas d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=79">Neurtre</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=79">Plutôt d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=79">Totalement d'accord</label>
		</div>
		<div class="form-group col-sm-12" ng-show="step==79">
			...
			<label class="col-sm-offset-1 col-sm-2"><input type="radio" name="q1_2" value="0" ng-click="step=80">Pas du tout d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="1" ng-click="step=80">Plutôt pas d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=80">Neurtre</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=80">Plutôt d'accord</label>
			<label class="col-sm-2"><input type="radio" name="q1_2" value="2" ng-click="step=80">Totalement d'accord</label>
		</div>
	</div>
