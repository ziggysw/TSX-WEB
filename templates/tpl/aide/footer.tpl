...
<div class="col-sm-offset-1 col-sm-8 alert alert-warning" role="alert">
	...
	<a target="_blank" href="https://github.com/ts-x/TSX-WEB/issues">ici</a> ou le modifier vous-même sur <a target="_blank" href="https://github.com/ts-x/TSX-WEB/tree/master/templates/tpl/aide">Github</a></p>
</div>
