						...
						<div id="GroupC" class="col-md-12 group">
							<div class="panel panel-wiki">
								...
								<div class="panel-body">
									...
									<br /><br />
									<p>Composée de Juges et de CTs dévoués, il traite de nombreuses plaintes diverses dans le but de faire respecter les lois et les devoirs des citoyens.<br />
