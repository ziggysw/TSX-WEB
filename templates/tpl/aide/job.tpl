			...
			<div class="row">
					...
					<div class="row">
						<div id="GroupA" class="col-md-12 group">
							<div class="panel panel-wiki">
								<div class="row">
									...
									<div class="col-md-11">
										<div id="GroupA" class="panel-heading panel-heading-wiki"><h2>Comment trouver un emploi</h2></div>
									</div>
								</div>
						...
						<div id="GroupB" class="col-md-12 group">
							<div class="panel panel-wiki">
								...
								<div class="panel-body">
									<p>Dans la ville de princeton il existe 12 commerces différentes qui recherche activement des employés pour répondre aux attentes de leur client, serez-vous à la hauteur ?</p>
									<br /><br />
				...
				<nav class="col-md-2 bs-docs-sidebar">
					<ul id="sidebar" class="nav nav-stacked fixed">
						<li>
							<a href="#GroupA">Comment trouver un emploi</a>
