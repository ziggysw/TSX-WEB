						...
						<!-- model du props -->		<div id="1006" class="hidden">models\props\cs_assault\moneypallet.mdl</div>
									...
									<div id="GroupASub2">
										...
										<div class = "row">
										   <div class = "col-sm-6 col-md-3">
												<div class = "thumbnail">
						<!-- photo du props -->		<img src = "/bootstrap/images/kittens.jpg" alt = "Arret de bus" style = "height:150px; width:300px;" >
												</div>
												<div class = "caption">
							<!-- Nom du props -->	<h3>Nom du props</h3>
			 <!-- Niveaux de risque de crash -->	<p><i><span style="color:green">Aucun risque</span></i></p>
													<p>
						<!-- model du props -->		<div id="XXXXX" class="hidden">COUCOU HIBOUX</div>
														<a onclick="copyToClipboard(document.getElementById('XXXXX').innerHTML)" class = "btn btn-warning" role = "button">1</a>
													</p>
												</div>
											</div>
											<div class = "col-sm-6 col-md-3">
