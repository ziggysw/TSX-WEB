<div class="container bs-docs-container" data-spy="scroll" data-target="#sidebar" ng-controller="vip">	<div class="row">		<div class="col-md-9" role="main">			<br /><br />			<center><img alt="img_title" id="img_title" src="/images/wiki/admin/admin_top.png"></center><br />			<br />			<div class="row">				<div id="GroupA" class="col-md-12 group">
			...
			</div>		</div>		<nav class="col-md-2 bs-docs-sidebar">			<ul id="sidebar" class="nav nav-stacked fixed">				<input class="pull-right form-control" placeholder="RECHERCHE" type="text" name="search" ng-model="filter" />				<br /><br /><br />				<li>					<a href="#GroupA">Tous les props</a>				</li>				<li>					<a href="#GroupB">Tous les skins ( à venir )</a>				</li>			</ul>		</nav>	</div></div>