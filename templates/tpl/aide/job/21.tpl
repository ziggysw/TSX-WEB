<div ng-controller="ctrlTabs" data-job="21">
	...
	<div class="tab-content" style="width:100%;"> 
		<div role="tabpanel" class="tab-pane active" ng-show="tabs=='desc'">
					...
					<hr class="featurette-divider">
					<p>McDonalds est une entreprise de fastfood au succès planétaire.<br />
					McDonald's compte plus de 31 000 restaurants à travers le monde et pas moins de 1200 d'entre eux en France.</p>
					<hr class="featurette-divider">
