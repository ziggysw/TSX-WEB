						...
						<div class="col-md-12" role="main">
							<div class="panel panel-wiki">
								<div class="row">
									...
									<div class="col-md-11">
										<div class="panel-heading panel-heading-wiki"><h2 id="t5" > En Developement</h2></div>
									</div>
								</div>
								<div class="panel-body">
									<p></p>
				...
				<div class=" col-md-1" role="complementary">
					<nav class="bs-docs-sidebar hidden-print hidden-sm hidden-xs affix"> 
						<ul class="nav bs-docs-sidenav target-active">
							<li><a href="#t1" id="page_menu_wiki" ><i class="fa fa-asterisk prune" aria-hidden="true"></i> Bienvenue</a></li>
							<li><a href="#t2" id="page_menu_wiki" ><i class="fa fa-asterisk ocean" aria-hidden="true"></i> Guide de survie</a></li>
							<li><a href="#t3" id="page_menu_wiki" ><i class="fa fa-asterisk gold" aria-hidden="true"></i> Les commandes de base</a></li>
							<li><a href="#t4" id="page_menu_wiki" ><i class="fa fa-asterisk pomme" aria-hidden="true"></i> Le Teamspeak</a></li>
							<ul class="nav target-active"><li><a href="#t4.1" class="sous_menu" id="page_menu_wiki"><i class="fa fa-asterisk pomme" aria-hidden="true"></i> Configurer son Teamspeak</a></li></ul>
							<li><a href="#t5" id="page_menu_wiki" ><i class="fa fa-asterisk blood" aria-hidden="true"></i> [ A venir]</a></li>
						</ul>
					</nav>
				</div>
			</div>
