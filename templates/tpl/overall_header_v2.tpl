		...
		<div class="follow-panel">
			<div class="container">
				...
				<ul class="follow-icon">
					<li><a href="https://www.facebook.com/pages/The-specialists-X/158129454222258"><i class="fa fa-facebook"></i></a></li>
					<li><a href="https://twitter.com/KoSSoLaX"><i class="fa fa-twitter"></i></a></li>
					...
					<li><a href="https://github.com/kossolax/TSX-RP"><i class="fa fa-github"></i></a></li>
				</ul>
			</div>
		</div>
	</header>
			...
			<div class="container">
				<nav class="navbar navbar-default" role="navigation">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="./"><img src="/images/bleue2.png" alt="tsX" width="400" height="100" /></a>
					</div>
