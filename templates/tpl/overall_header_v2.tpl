					...
					<ul class="nav navbar-nav navbar-right" style="z-index:2;">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li ng-show="data.job_id= 1 && data.job_id= 2 && data.job_id= 101 && data.job_id= 102 && Params.sub==steamid"><a href="/index.php?page=report"><i class="fa fa-phone"></i> Le téléphone</a></li>
